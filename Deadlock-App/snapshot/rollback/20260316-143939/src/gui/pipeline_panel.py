...
class PipelinePanel(QGroupBox):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self._btn_relaunch = QPushButton("Relaunch App")
        self._btn_relaunch.clicked.connect(self.relaunch_requested.emit)
        layout.addWidget(self._btn_relaunch)
        layout.addStretch()
    ...
    def _set_busy(self, busy: bool, msg: str = "Ready") -> None:
        ...
        self._btn_relaunch.setEnabled(not busy)

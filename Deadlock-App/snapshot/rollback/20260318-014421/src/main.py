...
from dataset_builder import DatasetBuilder, sync_roles_from_metadata
...
def run_dataset() -> None:
    ...
    builder.build_all()
    sync_roles_from_metadata()
    console.print("[green]roles.json synced from hero metadata.[/green]")
